 ...
 * creación y obtención de las instancias de los Business Objects (BOs)
 * en la aplicación. Sigue un patrón de fábrica simple, encapsulando la
 * lógica de instanciación de cada BO y sus dependencias (DAOs). Esto
 * promueve la separación de responsabilidades y facilita la gestión de
 * las dependencias en la capa de negocio.
 * @author Beto_
 */
public class ManejadorBO {
     ...
     * este método obtiene la instancia del DAO correspondiente ({@link ComandaDAO})
     * y la inyecta en el constructor del BO.
     *
    ...
    /**
     * Crea y devuelve una instancia del Business Object para la gestión de
     * mesas ({@link MesaBO}). Este método sigue el mismo patrón que los anteriores,
     * obteniendo la instancia del DAO de mesas ({@link MesaDAO}) y proporcionándola
     * al constructor del BO.
     *
