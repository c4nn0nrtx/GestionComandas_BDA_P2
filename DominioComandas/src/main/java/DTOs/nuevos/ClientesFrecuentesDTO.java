 ...
 * @author brand
 */
public class ClientesFrecuentesDTO {
     ...
     */
    public ClientesFrecuentesDTO(String nombres, String aPaterno, String aMaterno, String correo, String telefono, LocalDate fechaRegistro, Double totalGastado, Integer visitas, Integer puntosFidelidad) {
    ...
    public String toString() {
        return "ClientesFrecuentesDTO{" + "nombres=" + nombres + ", aPaterno=" + aPaterno + ", aMaterno=" + aMaterno + ", correo=" + correo + ", telefono=" + telefono + ", fechaRegistro=" + fechaRegistro + ", totalGastado=" + totalGastado + ", visitas=" + visitas + ", puntosFidelidad=" + puntosFidelidad + '}';
    }
